...
<div class="card" class="carousel-item active">
    <img src="https://media.discordapp.net/attachments/799534657523154967/1070996275459260416/Fresh__organic.png?width=1246&height=701" style="height: 500px; width:1000px;">
</div>
            ...
            <div class="row ">
                ...
                <div class="col" style="margin-top: 25px;                        ">
                    <div class="card" style="width: 18rem">
                        <div class="card-body">
                            <img src="{{ asset('images/' . $item->image) }}" class="card-img-top" width="18" height="400" />
                        </div>
                        <div class="card-body">
                                ...
                                <div class="d-grid gap-2" role="toolbar" aria-label="Toolbar with button groups">
                                    <div class="btn-group mr-2" role="group" aria-label="First group">
                                        <div class="d-flex mb-4" style="max-width: 300px">
                                            ...
                                            <button class="btn btn btn-lg btn-block" class="px-4 py-2 text-white bg-blue-800 rounded" style="background-color: #9c6d5a;height: 40px;width: 120px;padding: 0; color:white;border-radius:25px;">ใส่ตระกร้า</button>
                            </form>
                        @endauth
                        @unless (Auth::check())
